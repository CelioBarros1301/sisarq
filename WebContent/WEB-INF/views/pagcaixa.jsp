...
<html> 
    <head>
        ...
        <link type="text/css" href="${pageContext.request.contextPath}/resources/css/cssTableScrool.css" rel="stylesheet" media="screen"> 
    ...
    <body  onload="configurar" onload="addRowHandlers('row', 'rowMouseOver', 'SelectedFact.jsp', 'id', 0)">
        ...
        <div  class="container">
            <div class="row">
                ...
                <!-- Criacao da Tabela com Scrool Vertical e Head Fixo -->
                <div class="row">
	                <div class="col-xs-8 table-wrapper-scroll-y">
	                	<table class="table table-striped table-bordered table-sm w-auto" cellspacing="0" width="100%">
						    <thead>
							    <tr>
							        <th class="th-sm">Codigo Empresa
							        </th>
							        <th class="th-sm" >Nome Empresa
							        </th>
							        <th class="th-sm">Codigo Caixa
							        </th>
							        <th class="th-sm">Descricao Caixa
							        </th>
							    </tr>
						    </thead>
						    <tbody>
							    <c:forEach items="${gridEmpresa}" var="emp">
							        <tr>
							            <td>${emp.cdEmp}</td>
							            <td>${emp.dsEmp}</td>
							            <td>${emp.cdCaixa}</td>
